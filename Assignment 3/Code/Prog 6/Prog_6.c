...
void format_doc(FILE *fp, char *name) // format the doc
{
...
int comp_strings(char str1[MAX_WORD_SIZE], char str2[MAX_WORD_SIZE])
{
...
node *create_node(const char str[MAX_WORD_SIZE], const char doc_name[MAX_WORD_SIZE])
{
...
multiple *
* of STR_ARRAY_LEN however the file has came to end of it.
Thus, *
